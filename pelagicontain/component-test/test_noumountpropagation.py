...
class TestNoUmountPropagation():
    ...
    def test_second_container_doesnt_propagate_unmounts(
        ...
        first_container.start_pelagicontain(pelagicontain_binary, container_path)
        ...
        first_container.pelagicontain_iface().Launch(first_container.app_id())
        sleep(1)
        ...
        second_container.start_pelagicontain(pelagicontain_binary, container_path)
        sleep(1)
        assert os.path.exists(late_mounted_app_path)
