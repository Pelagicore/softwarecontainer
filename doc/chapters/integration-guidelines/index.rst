...
Service manifests should be installed in either ``/etc/softwarecontainer/caps.d/<service-name>`` or
``/etc/softwarecontainer/caps.default.d/<service-name>`` depending on if it should be applied by default
