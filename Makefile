...
pelagicontain: pelagicontain.c pulse.h pulse.c iptables.c trafficcontrol.c
	$(CC) pelagicontain.c pulse.c iptables.c trafficcontrol.c -o pelagicontain `pkg-config --cflags --libs libpulse`
